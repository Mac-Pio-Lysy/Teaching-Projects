...
namespace Program_No_1_XAML
{
    /// <summary>
    /// An empty page that can be used on its own or navigated to within a Frame.
    /// </summary>
    public sealed partial class MainPaige : Page
    {
        ...
        private void playArea_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
            if (humanCaptured)
            {
                ...
                Point relativePosition = Program_No_1_XAML.TransformToVisual(playArea).TransformPoint(pointerPosition);
